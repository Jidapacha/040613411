...
<body>
    ...
    $stmt->execute();
    if($_SESSION["pos"] === 'user'){
        echo "<h1>สวัสดี" . $_SESSION["fullname"] . "</h1>";
        echo "<h3>สิทธิ์ของผู้ใช้ " . $_SESSION["pos"] . "</h3>";
        echo "<h2>รายการสินค้า</h2>";
        echo "<table border='1'>";
        echo "<tr><th>ชื่อสินค้า</th><th>จำนวน</th></tr>";
    ...
    if($_SESSION["pos"] ==='admin'){
        ...
        while($row = $stmt->fetch()){
            ...
            echo "<tr>";
            echo "<td><a href='../cart/cart.php?action=&ord_id=" . $row["ord_id"] . "'>" . $row["ord_id"] . "</a></td>";
        ...
        echo "</table><br>";
        echo "<a href='login-form.php'>ไปหน้า login </a>  ";
        echo "<a href='../cart/stock.php'>ดูสินค้าคงเหลือ </a>";
    }
    ?>
</body>
</html>